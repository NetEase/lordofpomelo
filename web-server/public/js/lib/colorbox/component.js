...
var default_mouse_evt = {};

var HoverEventComponent = EventHandleComponent.extend({
  init:function(param)
  {
    param.types = ['mouseMoved'];
    HoverEventComponent.superClass.init.call(this, param);
  },
  ...
  update:function(host, t, dt)
  {
    ...
    //always query decide
    this._decider.decide(host, default_mouse_evt, this._selfPipe);
  },
});
